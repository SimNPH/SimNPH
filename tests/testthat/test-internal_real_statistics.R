test_that("internal function for real summary statistics outputs correct values", {
  ...
  result_1_c <- internal_real_statistics_pchaz_discrete(treatment_10, control_10, milestones=c("5m"=5, "10m"=10, "15m"=15)*10, cutoff=c("cutoff_5"=5, "cutoff_10"=10)*10)
  result_1_c[, c("median_survival_trt","median_survival_ctrl","rmst_trt_cutoff_5","rmst_ctrl_cutoff_5","rmst_trt_cutoff_10","rmst_ctrl_cutoff_10")] <-
    result_1_c[, c("median_survival_trt","median_survival_ctrl","rmst_trt_cutoff_5","rmst_ctrl_cutoff_5","rmst_trt_cutoff_10","rmst_ctrl_cutoff_10")] / 10

  # correct class, names, etc.
  expect_s3_class(result_1, "data.frame")
  expect_named(result_3, c("rmst_trt_15", "median_survival_trt", "rmst_ctrl_15", "median_survival_ctrl", "gAHR_15", "AHR_15", "AHRoc_15", "AHRoc_robust_15"), ignore.order = TRUE)
  ...
  expect_equal(result_2$AHRoc_5, 1)
  expect_equal(result_3$gAHR_15, 1)
  expect_equal(result_3$AHR_15, 1)
  expect_equal(result_3$AHRoc_15, 1)

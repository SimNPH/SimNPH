...
my_summarise <- create_summarise_function(
  ...
  milestone = summarise_estimator(est=milestone_surv_ratio[1], real= milestone_survival_ctrl_6m/ milestone_survival_trt_6m, lower=milestone_surv_ratio_lower[1], upper=milestone_surv_ratio_upper[1], null=1, name="milestone_6" ),
  milestone = summarise_estimator(est=milestone_surv_ratio[2], real=milestone_survival_ctrl_12m/milestone_survival_trt_12m, lower=milestone_surv_ratio_lower[2], upper=milestone_surv_ratio_upper[2], null=1, name="milestone_12"),

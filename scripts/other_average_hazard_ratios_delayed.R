...
design_original <- readRDS("../final_results/merged/delayed.Rds")

design_new <- design_original[, c("recruitment", "n_pat", "interim_events", "final_events", "n_ctrl",
                     "n_trt", "hazard_ctrl", "censoring_prop", "delay", "effect_size_ph",
                     "hazard_trt", "target_median_trt", "target_hr", "random_withdrawal"
)]
...
saveRDS(design_new, "data/other_ahrs_delayed.Rds")

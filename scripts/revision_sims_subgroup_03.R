...
design <- design[design$prevalence == 0.3, ]
...
saveRDS(results, paste0(save_folder, "/revision_results_subgroup_03_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"), ".Rds"))

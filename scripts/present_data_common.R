...
# method variable name      direction (one sided test)                                  name for output   estimator/test/gs-test  procedure category
  ...
  "milestone_6m",            "higher",                                    "milestone survival ratio 6m",             "estimator", "Ratio of Milestone Survival",
  "milestone_12m",           "higher",                                   "milestone survival ratio 12m",             "estimator", "Ratio of Milestone Survival",
  ...
  "fh_0_0",                        NA,                          "weighted logrank test, FH weights 0,0",                  "test", "Fleming-Harrington Test",
  "fh_0_1",                        NA,                          "weighted logrank test, FH weights 0,1",                  "test", "Fleming-Harrington Test",
  "fh_1_0",                        NA,                          "weighted logrank test, FH weights 1,0",                  "test", "Fleming-Harrington Test",
  "fh_1_1",                        NA,                          "weighted logrank test, FH weights 1,1",                  "test", "Fleming-Harrington Test",
  ...
  "fh_gs_0_0",                     NA, "weighted logrank test, FH weights 0,0, group sequential design", "group sequential test", "Fleming-Harrington Test",
  "fh_gs_0_1",                     NA, "weighted logrank test, FH weights 0,1, group sequential design", "group sequential test", "Fleming-Harrington Test",
  "fh_gs_1_0",                     NA, "weighted logrank test, FH weights 1,0, group sequential design", "group sequential test", "Fleming-Harrington Test",
  "fh_gs_1_1",                     NA, "weighted logrank test, FH weights 1,1, group sequential design", "group sequential test", "Fleming-Harrington Test",
...
#                   column name,                                            added column label, where's the var from?,          unit
         ...
         "median_survival_ctrl",                          "median survival in the control arm",   "true summary stat",        "days",
                ...
                "rmst_trt_360m",                             "RMST (30y) in the treatment arm",   "true summary stat",        "days",
               "rmst_ctrl_360m",                               "RMST (30y) in the control arm",   "true summary stat",        "days",
                    "gAHR_360m",                        "geometric average hazard ratio (30y)",   "true summary stat",          "HR",
                     "AHR_360m",                                  "average hazard ratio (30y)",   "true summary stat",          "HR",
                     "AHRoc_6m",                 "average hazard ratio Schemper 2009 (7) (6m)",   "true summary stat",          "HR",
                    "AHRoc_12m",                "average hazard ratio Schemper 2009 (7) (12m)",   "true summary stat",          "HR",
                   "AHRoc_360m",                "average hazard ratio Schemper 2009 (7) (30y)",   "true summary stat",          "HR",
              "AHRoc_robust_6m",                 "average hazard ratio Schemper 2009 (7) (6m) robust integration",   "true summary stat",          "HR",
             "AHRoc_robust_12m",                "average hazard ratio Schemper 2009 (7) (12m) robust integration",   "true summary stat",          "HR",
            "AHRoc_robust_360m",                "average hazard ratio Schemper 2009 (7) (30y) robust integration",   "true summary stat",          "HR",
  ...
  "milestone_survival_trt_360m",               "milestone survival in the treatment arm (30y)",   "true summary stat",    "fraction",
 "milestone_survival_ctrl_360m",                 "milestone survival in the control arm (30y)",   "true summary stat",    "fraction",
  ...
  "descriptive.sd_max_followup",                    "standard deviation of max follow up time",    "descriptive stat",      "number",
    ...
    "descriptive.sd_study_time",                       "standard deviation of length of study",    "descriptive stat",        "days",
                 "REPLICATIONS",                                      "number of replications",  "SimDesign metadata",      "number",
                  ...
                  "cover_upper",      "proportion of upper CI boundaries above the true value",           "summarise",    "fraction",
                   ...
                   "mean_n_evt",                                    "average number of events",           "summarise",      "number",
                    ...
                    "N_missing",                             "QC: number of missing estimates",           "summarise",      "number",
                            "N",                                      "number of replications",           "summarise",      "number",
                 "N_missing_CI",                                   "QC: number of missing CIs",           "summarise",      "number",
              "N_missing_upper",                       "QC: number of missing upper CI limits",           "summarise",      "number",
              "N_missing_lower",                       "QC: number of missing lower CI limits",           "summarise",      "number",
                 "N_missing_sd",  "QC: number of missing estimates for the standard deviation",           "summarise",      "number",
              "N_missing_n_pat",  "QC: number or replications with missing number of patients",           "summarise",      "number",
              "N_missing_n_evt",    "QC: number of replications with missing number of events",           "summarise",      "number",
              "N_missing_0.025",                              "QC: number of missing p-values",           "summarise",      "number",
          ...
          "N_missing_rejection",  "QC: number of missing rejection (group sequential designs)",           "summarise",      "number",
               "N_missing_npat",   "QC: missing number of patients (group sequential designs)",           "summarise",      "number",
               "N_missing_nevt",     "QC: missing number of events (group sequential designs)",           "summarise",      "number",
         "N_missing_study_time",           "QC: missing study time (group sequential designs)",           "summarise",      "number",
           "N_missing_followup",         "QC: missing max followup (group sequential designs)",           "summarise",      "number",

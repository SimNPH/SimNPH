...
# method variable name      direction (one sided test)                                  name for output   estimator/test/gs-test  procedure category
  ...
  "fh_0_0",                        NA,                          "weighted logrank test, FH weights 0,1",                  "test", "Fleming-Harington Test",
  "fh_0_1",                        NA,                          "weighted logrank test, FH weights 0,1",                  "test", "Fleming-Harington Test",
  "fh_1_0",                        NA,                          "weighted logrank test, FH weights 0,1",                  "test", "Fleming-Harington Test",
  "fh_1_1",                        NA,                          "weighted logrank test, FH weights 0,1",                  "test", "Fleming-Harington Test",
  ...
  "peto_peto_gs",                  NA,                        "Peto-Peto test, group sequential design", "group sequential test", "Fleming-Harington Test",
  "fh_gs_0_0",                     NA, "weighted logrank test, FH weights 0,1, group sequential design", "group sequential test", "Fleming-Harington Test",
  "fh_gs_0_1",                     NA, "weighted logrank test, FH weights 0,1, group sequential design", "group sequential test", "Fleming-Harington Test",
  "fh_gs_1_0",                     NA, "weighted logrank test, FH weights 0,1, group sequential design", "group sequential test", "Fleming-Harington Test",
  "fh_gs_1_1",                     NA, "weighted logrank test, FH weights 0,1, group sequential design", "group sequential test", "Fleming-Harington Test",

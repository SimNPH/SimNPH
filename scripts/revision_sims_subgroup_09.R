...
design <- design[design$prevalence == 0.9, ]
...
saveRDS(results, paste0(save_folder, "/revision_results_subgroup_09_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"), ".Rds"))

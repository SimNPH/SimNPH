...
# load parameters
design <- read.table("data/results/results_martin_2023-04/data/parameters/progression_os_2023-03-29.csv", sep=",", dec=".", header=TRUE)
...
# load seeds --------------------------------------------------------------
old_sims <- readRDS("data/results/results_martin_2023-04/data/simulation_progression_ims-node1_2023-04-05_151339/results.Rds")

# run ---------------------------------------------------------------------

save_folder <- "data/results/results_martin_2023-04/data/simulation_progression_ims-node1_2023-04-05_151339"

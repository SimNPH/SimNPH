...
# load parameters
design <- read.table("data/parameters/additional_crossing_2023-04-19.csv", sep=",", dec=".", header=TRUE)
...
save_folder <- "data/results/crossing"
...
saveRDS(results, paste0(save_folder, "/additional_results_crossing_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S"), ".Rds"))

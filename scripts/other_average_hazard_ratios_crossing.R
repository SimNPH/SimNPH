...
design_original <- readRDS("../final_results/merged/crossing.Rds")

design_new <- design_original[, c("recruitment", "n_pat", "interim_events", "final_events", "n_ctrl",
                     "n_trt", "hazard_ctrl", "censoring_prop", "crossing", "effect_size_ph",
                     "hazard_trt_after", "hazard_trt_before", "target_median_trt", "target_hr", "random_withdrawal", "hr_before"
)]
...
saveRDS(design_new, "data/other_ahrs_crossing.Rds")

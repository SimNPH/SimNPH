...
merged_delayed <- merge_additional_results(old_delayed, new_delayed, descriptive_regex = "^descriptive")
...
merged_crossing <- merge_additional_results(old_crossing, new_crossing, descriptive_regex = "^descriptive")
...
merged_progression <- merge_additional_results(old_progression, new_progression, descriptive_regex = "^descriptive")

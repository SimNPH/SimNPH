...
# load parameters
design <- read.table("data_sim_study/parameters/revision_progression_os_2023-05-24.csv", sep=",", dec=".", header=TRUE)
...
save_folder <- paste0(paste0("data/revision_2_progression_", Sys.info()["nodename"], "_", strftime(Sys.time(), "%Y-%m-%d_%H%M%S")))

;; SCENARIO 16 
$PROBLEM    JOINT MODEL SCENARIO 16
...
-1.622 ; GROUP 1=1,GROUP 2 =0
-0.3783 ; concentration in effect compartment
;*****TREATMENT DURATION*****
...
$SIGMA  0.219  FIX  ;         RV
$SIMULATION (674933) (60315 UNIFORM) (947262 UNIFORM) ONLYSIM NSUB=1 ;

...
for(i in 1:2500){
  ...
  Raw_mod[287] <- paste("0.021 ; baseline hazard", sep = '')  
  Raw_mod[230] <- paste("\"   OPEN (99, FILE = 'simtab",i,".dat', POSITION='APPEND')", sep='')
  Raw_mod[297] <- paste("-0.3817 ; treatment effect in the effect compartment" , sep='' )
  Raw_mod[296] <- paste("-1.6222 ; GROUP 1=1, GROUP 2 =0", sep='') 
  Raw_mod[301] <- paste( "0.0000536 ; eliminatin rate constant of the effect compartment", sep = '')

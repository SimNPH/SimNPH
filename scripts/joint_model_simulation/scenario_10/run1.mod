;; SCENARIO 10
$PROBLEM    JOINT MODEL SCENARIO 10
...
-0.367 ; treatment effect in the effect compartment
;*****TREATMENT DURATION*****
0.008887 ; LAMBDA value log(2)/(median treatment duration)
;*****EFFECT COMPARTMENT*****
0.0000536 ; elimination rate constant of the effect compartment
$OMEGA  BLOCK(2) FIX
0.0728  ;  IIV on CL
...
$SIGMA  0.219  FIX  ;         RV
$SIMULATION (555106) (954149 UNIFORM) (563986 UNIFORM) ONLYSIM NSUB=1 ;

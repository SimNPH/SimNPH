;; SCENARIO 18
$PROBLEM    JOINT MODEL SCENARIO 18
...
-0.953 ; GROUP 1=1,GROUP 2 =0
-0.2505 ; concentration in effect compartment
;*****TREATMENT DURATION*****
...
$SIGMA  0.219  FIX  ;         RV
$SIMULATION (461779) (966706 UNIFORM) (285803 UNIFORM) ONLYSIM NSUB=1 ;

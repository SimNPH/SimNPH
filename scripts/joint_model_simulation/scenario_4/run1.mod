;; SCENARIO 4
$PROBLEM    JOINT MODEL SCENARIO 4
...
;*****EFFECT COMPARTMENT*****
0.000053 ; eliminatin rate constant of the effect compartment
$OMEGA  BLOCK(2) FIX
0.0728  ;  IIV on CL
...
$SIGMA  0.219  FIX  ;         RV
$SIMULATION (844530) (668801 UNIFORM) (321980 UNIFORM) ONLYSIM NSUB=1 ;

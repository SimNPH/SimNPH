;; SCENARIO 2
$PROBLEM    JOINT MODEL SCENARIO 2
...
COM(4) = 52560 ; Set max time/censoring time
ENDIF
...
0 FIX; GROUP 1=1, GROUP 2 =0
0 FIX; concentration effect in effect compartment
;*****TREATMENT DURATION*****
0.001925 ; LAMBDA value log(2)/(median treatment duration)
;*****EFFECT COMPARTMENT*****
0.000065 ; eliminatin rate constant of the effect compartment
$OMEGA  BLOCK(2) FIX
0.0728  ;  IIV on CL
...
$SIGMA  0.219  FIX  ;         RV
$SIMULATION (883188) (709033 UNIFORM) (455153 UNIFORM) ONLYSIM NSUB=1 ;

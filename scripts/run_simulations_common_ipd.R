...
my_summarise <- create_summarise_function(
  ...
  median_surv = summarise_estimator(est=diff_Q, real=median_survival_diff, lower=diff_Q_lower, upper=diff_Q_upper, null=0),
  milestone_6m = summarise_estimator(est=milestone_surv_ratio, real= milestone_survival_ratio_6m, lower=milestone_surv_ratio_lower, upper=milestone_surv_ratio_upper, null=1),
  milestone_12m = summarise_estimator(est=milestone_surv_ratio, real=milestone_survival_ratio_12m, lower=milestone_surv_ratio_lower, upper=milestone_surv_ratio_upper, null=1),
  ...
  diff_med_weibull = summarise_estimator(est=diff_med_est, real=median_survival_diff,lower=diff_med_lower, upper=diff_med_upper, null=0),
  # tests
